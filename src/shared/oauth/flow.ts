...
// biome-ignore lint/complexity/noExcessiveCognitiveComplexity: OAuth authorize flow has required branches
...
// biome-ignore lint/complexity/noExcessiveCognitiveComplexity: OAuth token flow has required branches
export async function handleToken(
  ...
  if (input.grant === "refresh_token") {
    ...
    const newAccess = providerRefreshRotated
      ? generateOpaqueToken(24)
      : undefined;
